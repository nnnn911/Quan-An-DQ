...
import { formatPrice, getMenu, createOrder, incrementMenuSoldCounts } from '../../data/store.js';
...
const createPosOrder = ({ staff, cart, payment }) => {
...
const renderLogin = () => {
  ...
  form.addEventListener('submit', (e) => {
    ...
    const result = loginStaff(phone, password);
    if (!result.ok) {
