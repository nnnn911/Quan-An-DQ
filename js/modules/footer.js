      ...
      <div class="footer-grid">
        <div>
          <div class="footer-brand-logo">
            ...
            <span class="footer-brand-name">Đồng Quê</span>
          </div>
          ...
          <div class="footer-contact-row"><span class="footer-contact-icon">📍</span> Khu đô thị Sala, Phường An Khánh, TP.HCM</div>
          <div class="footer-contact-row"><span class="footer-contact-icon">📞</span> 0909 234 567</div>
          <div class="footer-contact-row"><span class="footer-contact-icon">✉️</span> contact@quanandongque.vn</div>
          <div class="footer-contact-row"><span class="footer-contact-icon">🕐</span> 7:00 - 22:00 (Thứ hai - Chủ nhật)</div>
        </div>
        <div>
